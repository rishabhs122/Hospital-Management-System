...
namespace HospitalMS
{
    public partial class updatePatient : Form
    {
        ...
        public void idList()
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = " select id from addPatient";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = " select * from addPatient where id='"+selectId+"'";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = con;
            cmd.CommandText = "update addPatient SET contact = "+contact+", mode = '"+mode+"' where id = '"+selectId+"' ";
            SqlDataAdapter ad = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            ad.Fill(ds);
